...
def read_file_from_s3(grib_file):
    ...
    return fsspec.open_local(
        uri,
        mode="rb",
        s3={"anon": True, "client_kwargs": {"endpoint_url": os.environ.get("S3_HOSTNAME", "https://eris.fmi.fi")}},
    )
    ...
    if args.output.startswith("s3://"):
        openfile = fsspec.open(
            ...
            s3={
                ...
                "client_kwargs": {"endpoint_url": os.environ.get("S3_HOSTNAME", "https://eris.fmi.fi")},
            },
        )
